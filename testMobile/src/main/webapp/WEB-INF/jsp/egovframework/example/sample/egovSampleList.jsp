...
<html>
	<head>
        ...
        <script src="<c:url value="/js/egovframework/mbl/cmm/jquery.mobile-1.3.2.min.js" />"></script>
        <script src="<c:url value="/js/egovframework/mbl/cmm/EgovMobile-1.3.2.js" />"></script>
